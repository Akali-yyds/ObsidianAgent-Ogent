...
- [x] **UI-04**: User can inspect grounded-research transparency by clicking the existing Retriever, Synthesizer, and Verifier step blocks instead of opening a separate `Agent work` surface.
