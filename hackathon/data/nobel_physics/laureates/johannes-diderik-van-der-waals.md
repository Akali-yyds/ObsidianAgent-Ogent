...
source: "https://en.wikipedia.org/wiki/Johannes_Diderik_van_der_Waals"
...
**Johannes Diderik van der Waals** ( ˈdidərɪk fɑn dər ˈʋaːls] ⓘ; 23 November 1837 – 8 March 1923) was a Dutch theoretical physicist who received the Nobel Prize in Physics in 1910 "for his work on the equation of state for gases and liquids." Van der Waals started his career as a schoolteacher, before becoming the first physics professor of the University of Amsterdam when its status was upgraded to Municipal University in 1877.
...
| * History * Culture |
| Scientists  * Bernoulli * Boltzmann * Bridgman * Callen * Carathéodory * Carnot * Clapeyron * Clausius * de Donder * Duhem * Gibbs * von Helmholtz * Joule * Kelvin * Lewis * Massieu * Maxwell * von Mayer * Nernst * Onsager * Planck * Rankine * Smeaton * Stahl * Tait * Thompson * van der Waals * Waterston |
