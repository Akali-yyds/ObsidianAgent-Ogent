---
title: "Donald Glaser"
source: "https://en.wikipedia.org/wiki/Donald_Glaser"
...
While teaching at Michigan, Glaser began to work on experiments that led to the creation of the bubble chamber.: 37 His experience with cloud chambers at Caltech had shown him that they were inadequate for studying elementary particles. In a cloud chamber, particles pass through gas and collide with metal plates that obscure the scientists' view of the event. The cloud chamber also needs time to reset between recording events and cannot keep up with accelerators' rate of particle production.: 31–32

He experimented with using superheated liquid in a glass chamber. Charged particles would leave a track of bubbles as they passed through the liquid, and their tracks could be photographed. He created the first bubble chamber with ether.: 37–38 He experimented with hydrogen while visiting the University of Chicago, showing that hydrogen would also work in the chamber.: 44
...
After winning the Nobel Prize, Glaser began to think about switching from physics into a new field. He wanted to concentrate on science, and found that as the experiments and equipment grew larger in scale and cost, he was doing more administrative work. He also anticipated that the ever-more-complex equipment would cause consolidation into fewer sites and would require more travel for physicists working in high-energy physics.: 68
Recalling his interest in molecular genetics that began at Caltech, Glaser began to study biology. He spent a semester at MIT as a visiting professor and attended biology seminars there, and also spent a semester at Copenhagen with Ole Maaloe, the prominent Danish molecular biologist.: 72
...
He worked in UC Berkeley's Virus Lab (now the Biochemistry and Virus Laboratory),: 76 doing experiments with bacterial phages, bacteria, and mammalian cells. He studied the development of cancer cells, in particular the skin cancer *xeroderma pigmentosum*.: 69 As with the bubble chamber, he used his experience designing equipment to improve the experimental process. He automated the process of pouring out agar, spreading culture, and counting colonies of cells using a machine he called the dumbwaiter. It took photographs, administered chemicals, and had a mechanical hand to pick up colonies.: 76–77

## Commercial ventures

edit

While continuing to work at UC Berkeley, Glaser started Berkeley Scientific Laboratory with Bill Wattenberg in 1968. The short-lived partnership worked on automating diagnostic procedures.: 88

In 1971 he founded Cetus Corporation with Moshe Alafi, Ron Cape, and Peter Farley.: 89–90 Glaser's position was chairman of the science advisory board.: 96 The founders felt that the knowledge scientists had gained about DNA had not yet been applied to solve real problems.: 112 The company did microbial strain improvement,: 96–97 and then genetic engineering,: 110 becoming the first biotechnology company. Cetus was purchased by Chiron Corporation in 1991.: 115

## Transition to neurobiology

edit

As molecular biology became more dependent on biochemistry, Glaser again considered a career change. His experience automating visual tasks in physics and molecular biology led him to an interest in human vision and how the brain processes what is seen. He began to work on computational modeling of the visual system and visual psychophysics, and spent a sabbatical at the Rowland Institute for Science.: 116
