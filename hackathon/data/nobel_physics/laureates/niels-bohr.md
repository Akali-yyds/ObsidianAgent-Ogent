...
where *m*e is the electron's mass, *e* is its charge, *h* is the Planck constant and *Z* is the atom's atomic number (1 for hydrogen).
...
Bohr *(left)* and Albert Einstein, pictured on 11 December 1925, had a long-running debate about the metaphysical implication of quantum physics.
...
Werner Heisenberg *(left)* with Bohr at the Copenhagen Conference, 1934.
...
Bohr *(left)* with James Franck, Albert Einstein and Isidor Isaac Rabi, 1954.
