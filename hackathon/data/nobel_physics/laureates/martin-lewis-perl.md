...
source: "https://en.wikipedia.org/wiki/Martin_Lewis_Perl"
...
The tau was first detected in a series of experiments between 1974 and 1977 by Perl with his colleagues at the SLAC-LBL group. Their equipment consisted of SLAC's then-new e+  
–e−  
...
This was difficult to verify, because the energy to produce the τ+  
τ−  
 pair is similar to the threshold for D meson production. Work done at DESY-Hamburg, and with the Direct Electron Counter (DELCO) at SPEAR, subsequently confirmed the discovery and established the mass and spin of the tau.
